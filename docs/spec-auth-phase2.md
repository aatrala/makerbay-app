...
Status: **v2 APPROVED 2026-09-09 on the defaults; Part A LIVE 2026-09-09; Part B0 (auth on the dashboard's origin) LIVE 2026-09-09; Part B1 (passkeys) LIVE 2026-09-09; founder passkey sign-in on a phone confirmed and the old api. Cognito callback removed 2026-09-10, so one callback is registered.**
